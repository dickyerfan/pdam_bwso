         ...
         <div class="modal-dialog modal-lg">
             <div class="modal-content" style="background-color: transparent; border:none;">
                 <!-- <div class="modal-header">
                     <h5 class="modal-title" id="modalCarouselLabel">Carousel Modal</h5>
                 ...
                 <div class="modal-body">
                     <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                         <div class="carousel-inner">
                             ...
                             <div class="carousel-item">
                                 <a href="<?= base_url('ijenWater') ?>">
                                     <img src="<?= base_url('assets/img/ijen.jpg') ?>" class="d-block w-100" alt="Gambar 2">
                                     <div class="carousel-caption">
                                         <p class="text-light">Klik untuk lihat Detail Ijen Water</p>
                                     </div>
                                 </a>
                             </div>
                         </div>
