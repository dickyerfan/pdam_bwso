<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark logo">
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle fw-bold ustadz" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 0.8rem;"><?= ucfirst($this->session->userdata('nama_pengguna')); ?></a>
